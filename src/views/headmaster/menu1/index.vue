  ...
  <div>
    <el-table v-loading="listLoading" :data="tableData" style="width: 150%">
      ...
      <el-table-column label="性别">
        <template slot-scope="scope">
          <div v-if="scope.$index === updateShow" style="display:flex;">
            ...
            <el-radio v-model="sex" style="margin-left:-15px;" label="女"
              >女</el-radio
            >
          </div>
      ...
      <el-table-column v-if="power" align="center">
        ...
        <template slot-scope="scope">
          <el-button size="mini" type="primary" @click="open(scope)"
            >修改</el-button
          >
          <el-button
            size="mini"
    ...
    <el-button v-if="power" type="primary" class="addHead" @click="addHeads"
      >添加班主任</el-button
    >
    <!-- 分页模块 -->
    <pageCount
      style="position:fixed;left:205px;  top:520px;"
      :total="total"
      :page-size="pageSize"
