<template>
  <div>
    ...
    <el-button v-if="power" type="primary" class="addHead" @click="addHeads">添加班主任</el-button>
    <!-- 分页模块 -->
    <pageCount style="position:fixed;left:205px;  top:520px;" :total="total" :page-size="pageSize" :current-page="currentPage" @getcurrentPage="getcurrentPage" />
  </div>
</template>
